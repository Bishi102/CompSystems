...
output-list sp%D1.6.1 local%D1.6.1 argument%D1.8.1 this%D1.6.1 that%D1.6.1
            RAM[16]%D1.7.1 RAM[17]%D1.7.1 RAM[18]%D1.7.1 RAM[19]%D1.7.1 RAM[20]%D1.7.1
...
repeat 60 {        // Change this number to cover the number of instructions in the VM test file
  vmstep;
}
output;
